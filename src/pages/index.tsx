...
const BigCourseCard = () => {
  return (
    <Link href="/course" className="border-none">
      <div className="mb-3 flex h-[350px] w-full flex-col justify-center rounded border border-gray-200 bg-white shadow-md transition duration-500 hover:-translate-y-4 hover:shadow-2xl dark:border-gray-400 dark:bg-dark-90 lg:w-auto">
