const BigCourseCard = () => {
  return (
    <div className="flex h-[350px] py-6 flex-col w-full rounded transition transform hover:-translate-y-4 shadow-md hover:shadow-2xl duration-500 mb-3 justify-center border border-gray-200 bg-white">
      ...
      <div className="py-4 px-5 flex flex-col h-[75%] gap-2">
